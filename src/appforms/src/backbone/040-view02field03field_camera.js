FieldCameraView = FieldView.extend({
  ...
  html5Cam: '<div class="html5Cam">' + '<div class="camActionBar"><button class="camCancel camBtn">Cancel</button><button class="camOk camBtn">Ok</button></div>' + '<div class="cam"></div>' + '</div>',
