...
var f=b.models.submissions.findMetaByRemoteId(a.submissionId);null===f?($fh.forms.log.d("downloadSubmission submission does not exist, downloading",a),e=new b.models.submission.newInstance(null,{submissionId:a.submissionId}),e.on("error",d),e.on("downloaded",d),"function"==typeof a.updateFunction&&e.on("progress",a.updateFunction),"function"==typeof c&&(j[a.submissionId]?j[a.submissionId].push(c):(j[a.submissionId]=[],j[a.submissionId].push(c))),e.download(function(a){return a?($fh.forms.log.e("Error queueing submission for download "+a),c(a)):void 0})):($fh.forms.log.d("downloadSubmission submission exists",a),"downloaded"!==f.status?"function"==typeof c&&(j[a.submissionId]?j[a.submissionId].push(c):(j[a.submissionId]=[],j[a.submissionId].push(c))):b.models.submissions.getSubmissionByMeta(f,c))}a.getForms=c,a.getForm=d,a.getTheme=e,a.submitForm=g,a.getSubmissions=f,a.downloadSubmission=h,a.init=b.init,a.log=b.models.log;var i=null,j={},k=b.models.config,l=function(a){a=a?a:"",$fh.forms.log.w("Default Function Called "+a)},m={editAllowed:function(){var a=k.get("defaultConfigValues",{});return a.config_admin_user===!0},get:function(a){if(a){var b=k.get("userConfigValues",{}),c=k.get("defaultConfigValues",{});return b[a]?b[a]:c[a]}},getDeviceId:function(){return k.get("deviceId","Not Set")},set:function(a,b){var c=this;if("string"==typeof a&&"undefined"!=typeof b&&null!==b&&(c.editAllowed()||"max_sent_saved"===a)){var d=k.get("userConfigValues",{});d[a]=b,k.set("userConfigValues",d)}},getConfig:function(){var a=this,b=k.get("defaultConfigValues",{}),c=k.get("userConfigValues",{}),d={};if(a.editAllowed()){for(var e in b)d[e]=c[e]?c[e]:b[e];return d}return b},saveConfig:function(a){k.saveLocal(function(b){b?$fh.forms.log.e("Error saving a form config: ",b):$fh.forms.log.l("Form config saved sucessfully."),"function"==typeof a&&a()})},offline:function(){k.setOffline()},online:function(){k.setOnline()},mbaasOnline:function(a){"function"==typeof a&&k.on("online",a)},mbaasOffline:function(a){"function"==typeof a&&k.on("offline",a)},isOnline:function(){return k.isOnline()},isStudioMode:function(){return k.isStudioMode()},refresh:function(a){k.refresh(!0,a)}};return a.config=m,a}(b.api||{}),"undefined"==typeof $fh&&($fh={}),void 0===$fh.forms&&($fh.forms=b.api),b&&(b.RulesEngine=a)}(window||module.exports);
>>>>>>> allow assign multiple notification listeners for sync
