...
function _completeSubmission(req, res){
  ...
  var resJSON = {"status" : "complete"};
  if(req.params.submissionId === "submissionNotComplete"){
    resJSON = {"status" : "pending", "pendingFiles" : ["filePlaceHolder123456"]};
